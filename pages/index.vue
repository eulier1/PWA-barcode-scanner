  ...
  <section class="bg-landingpage">
    ...
    <div v-if="showError" class="bg-orange-darkest text-center py-4 lg:px-4 relative z-50">
      ...
      >
        ...
        >Couldn't read the barcode, please try it again.</span>
        <svg
    ...
    <h4 class="description text-grey-light px-2">Scan a barcode to get nutritional food value</h4>
...
import * as staticImg from "../static/20190204_154501.jpg";
...
export default {
  ...
  methods: {
    ...
    capture(ev) {
      ...
      barcode = this.generateBarcode(canvas.toDataURL("image/jpeg", 1));
